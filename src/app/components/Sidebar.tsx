...
export const Sidebar = ({
    ...
    return (
      <>
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              className="text-[var(--text)] h-[calc(100vh-4rem)] flex flex-col fixed top-16 left-0 z-50 border-r border-[var(--border)] bg-[var(--surface)] overflow-hidden w-[80%] max-w-xs"
              initial={{ x: "-100%" }}
              animate={{ x: 0 }}
              exit={{ x: "-100%" }}
              layout
            >
              <div className="p-3 flex items-center justify-between h-[60px] border-b border-[var(--border)]">
                <button
                ...
                <motion.button
                  onClick={onClose}
                  className="grid h-10 w-10 place-content-center text-lg border-transparent hover:bg-[var(--surface-hover)] border hover:border-[var(--border-hover)] rounded transition-colors text-[var(--text-secondary)] hover:text-[var(--text)]"
                  whileTap={{ scale: 0.9 }}
  ...
  return (
    ...
    >
      ...
      <motion.div
        layout
        className="p-3 flex items-center justify-between h-[60px] border-b border-[var(--border)]"
      >
